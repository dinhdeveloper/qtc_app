...
public class ListCategoryProductAdapter extends SuperAdapter<CategoryProductModel> {
    ListCategoryProductListener listener;
    Context context;
    boolean checkClick = true;

    public interface ListCategoryProductListener {
        void onClickItem(CategoryProductModel model);
    }

    public void setListener(ListCategoryProductListener listener) {
    ...
    @Override
    public void onBind(SuperViewHolder holder, int viewType, int layoutPosition, CategoryProductModel item) {
